import { createRegion, type RegionSettings } from './browser.ts';

// Paths on Vite's server over the repo root; new URL(…, import.meta.url) would be rewritten
export const assetsBaseUrl = '/vendor';

export const createTestRegion = (settings: RegionSettings = {}) =>
  createRegion({ ...settings, assetsBaseUrl, indexURL: '/node_modules/pyodide/' });
